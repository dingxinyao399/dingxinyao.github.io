---
title: java二维码生成
date: 2018-07-24 10:47:08
tags: [java,二维码,QR code]
categories: 
  - java
  - 二维码
  - QR code
...
最近做项目时遇到一个需要导出PDF且里带有二维码的功能，就觉得二维码的代码很有意思，记录下

转自https://blog.csdn.net/jinqilin721/article/details/78841028
...
public final class QRCodeUtil extends LuminanceSource {
   ...
   /* *//**
    ...
    public static void main(String[] args) {
        String text = "http://baidu.com/controller?1=1"; // 随机生成验证码
        System.out.println("随机码： " + text);
        int width = 165; // 二维码图片的宽
        int height = 165; // 二维码图片的高
